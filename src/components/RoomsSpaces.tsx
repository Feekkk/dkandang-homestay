...
import { Bed, Bath, Users, Maximize, Sofa, UtensilsCrossed } from "lucide-react";
          ...
          {rooms.map((room, index) => (
            <Card key={index} className="overflow-hidden border-0 shadow-hover hover:shadow-warm transition-all duration-500 group">
              ...
              <CardContent className="p-6">
                ...
                <Button variant="outline" className="w-full group-hover:bg-homestay-warm group-hover:text-white group-hover:border-homestay-warm transition-all duration-300">
                  View Gallery
                </Button>
              </CardContent>
            </Card>
